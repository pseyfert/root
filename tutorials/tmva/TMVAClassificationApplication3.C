...
#include "./dataset/weights/TMVAClassification_MLP.class.C"
#include "TH1F.h"
...
void TMVAClassificationApplication( TString myMethodList = "" )
{
   ...
   std::vector<std::string> inputVars({"var1+var2","var1-var2","var3","var4"});
   IClassifierReader* reader = new ReadMLP(inputVars);
